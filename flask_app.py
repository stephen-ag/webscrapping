...
def index():
    if request.method == 'POST':
        ...
        try:
            a = 1
            #myclient = pymongo.MongoClient("mongodb://localhost:27017/")  # opening a connection to Mongo
            #db = myclient['crawlerDB'] # connecting to the database called crawlerDB
            ...
            return 'something issssssssssssss wrong'
