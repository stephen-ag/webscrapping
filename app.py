...
# base url + /
#http://localhost:8000 + /
@app.route('/search',methods=['POST']) # route with allowed methods as POST and GET
def index():
    if request.method == 'POST':
        ...
        try:
            ...
            #flipkart_url= 'https://www.flipkart.com/search?q=iphone+11'
            ...
            #bigboxes = flipkart_html.findAll("div", {"class":"_4rR01T "}) # seacrhing for appropriate tag to redirect to the product link
